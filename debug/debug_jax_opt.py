...
loss_bundle['compiled_ivp_solver_arr'] = me_mod_fo.jax_ivp_closed_stiff_compiled_solver_

kwargs_cp = deepcopy(loss_bundle)
#%%

def loss_wrapper_for_grad():
    """
...
##%%
res_nojit = loss_wrapper_for_grad()
##%%
#res_nojit2 = loss_wrapper_for_grad()
#%%
...
#this fails
(loss, aux_data), grads = fo_value_and_grad()
