...
The most obvious production use-case seems to be a clinical product trained and validated on your organization's PK data and clinical outcomes to provide an in-network dose optimization dashboard similar to the one discussed by Xong et al. (http://dx.doi.org/10.1002/cpt.2148). An open-source, transparent, and royalty-free methodology like that in NiceODE can be a powerful tool for developing such systems.

For example, the scientific consensus on how to best model certain covariates is constantly evolving. The utility of including anti-drug antibodies (ADAs) in PK models is a topic of discussion (https://doi.org/10.3390/pharmaceutics13081191), as modern combination therapies have reduced the prevalence of ADAs in many patients (https://doi.org/10.1111/bcp.16126). A key advantage of an open-source framework is the ability to rapidly incorporate these new, consensus-driven best practices to ensure models remain aligned with the current standard of care. 
